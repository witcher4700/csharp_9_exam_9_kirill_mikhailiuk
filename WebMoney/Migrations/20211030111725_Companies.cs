    ...
    public partial class Companies : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "BankAccounts",
                columns: new[] { "Id", "MoneyCount", "UniqueNumber", "UserId" },
                values: new object[,]
                {
                    { 2, 0.0, "MEGACOM11111", "1" },
                    { 3, 0.0, "AKNET2222222", "2" },
                    { 4, 0.0, "SVET33333333", "3" },
                    { 5, 0.0, "GAS444444444", "4" },
                    { 6, 0.0, "O!5555555555", "5" }
                });

            migrationBuilder.InsertData(
                table: "CompanyUsers",
                columns: new[] { "Id", "CompanyId", "PhoneNumber", "Walletnumber" },
                values: new object[,]
                {
                    { 1, 1, "996551222770", null },
                    { 2, 2, "996551222770", null },
                    { 3, 3, "996551222770", null },
                    { 4, 4, "996551222770", null },
                    { 5, 5, "996551222770", null }
                });

            migrationBuilder.InsertData(
                table: "ServiceCompanies",
                columns: new[] { "Id", "CompanyType", "Name" },
                values: new object[,]
                {
                    { 1, 1, "Megacom" },
                    { 2, 2, "Aknet" },
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UniqueСode = table.Column<string>(type: "text", nullable: true),
